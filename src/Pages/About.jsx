        ...
        <div className="container py-4 my-2 border text-center">
            ...
            <div className="row">
                <aside className="col py-2 my-4 ">
                    <h2 className="text-body">Licensed Vendor <i className="bi bi-check ms-2"></i> </h2>
                ...
                <aside className="col py-2 my-4 ">
                    <h2 className="text-body">Contact Us <i className="bi bi-person-lines-fill ms-2"></i> </h2>
            ...
            <div className="row">
                <section className="col py-2 my-4 ">
                    <h2 className="text-body">Open-House <i className="bi bi-house ms-2"></i> </h2>
